...
*****************************************/
DROP DATABASE IF EXISTS my_guitar_shop1; -- check to see if this database exists already if not use this name
CREATE DATABASE my_guitar_shop1; -- create database with name my_guitar_shop1
USE my_guitar_shop1;  -- MySQL command, use this database to edit 
...
-- grant : select insert delete update are all things the user can do who is being granted access to the database
GRANT SELECT, INSERT, DELETE, UPDATE
ON my_guitar_shop1.* -- granted access on only this table
TO mgs_user@localhost
IDENTIFIED BY 'pa55word';

GRANT SELECT
ON products
TO mgs_tester@localhost -- this is the username for the user to log in
IDENTIFIED BY 'pa55word';-- this is the password for the user to log in
...
ON * -- star indicates all tables within the database
TO mgs_user@localhost
IDENTIFIED BY 'pa55word';